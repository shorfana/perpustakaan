                    ...
                    <div class="row">
                        ...
                        ?>
                            <form method="post" action="<?php echo base_url() ?>buku/submits" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sinopsis
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="sinopsis" value="<?php echo $detail->SINOPSIS ?> class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" name="isbn" value="<?php echo $detail->ISBN ?> class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">cover
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">file pdf
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="file" value="<?php echo $detail->FILE_BUKU ?>" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
